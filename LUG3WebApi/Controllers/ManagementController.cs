...
namespace LUG3WebApi.Controllers 
{
    ...
    public class ManagementController : ControllerBase 
    {
        ...
        //Si estado = 2 --> Hay una meeting, result de meeting instance 1 (3)
        ...
        [HttpGet]
        [Route ("ResultView/{IdPostulant}")]
        //GET api/Management/ResultView/{IdPostulant}
        public IEnumerable<ResultDetailsView> GetResultView (int IdPostulant)
        {
            return dbm.GetResultsforView(IdPostulant);
        }
        ...
        public async Task<IActionResult> GetFileResult(int IdResult)
        {
            ...
            string fileextension = file.Name.Split(".")[file.Name.Split(".").Length-1];
            memory.Position = 0;
            return File(memory, fnc.getMimeTypes(fileextension), file.Name); 
        }
